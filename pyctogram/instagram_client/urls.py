...
CHECK_USERNAME_URL = f'{API_URL}/users/check_username/'
CHANGE_PASSWORD_URL = f'{API_URL}/accounts/change_password/'
SEND_CONFIRM_EMAIL_URL = f'{API_URL}/accounts/send_confirm_email/'
SEND_SMS_CODE_URL = f'{API_URL}/accounts/send_sms_code/'
VERIFY_SMS_CODE_URL = f'{API_URL}/accounts/verify_sms_code/'
PUSH_REGISTER = f'{API_URL}/push/register/'
GET_STORY_FEED_URL = f'{API_URL}/feed/user/%d/story/'
